...
def listar_pastas_e_arquivos(caminho, page, nivel=0, filtro=""):
    ...
    try:
        ...
        arquivos_ignorados = ['desktop.ini','outros.py','__pycache__']
...
def voltar(page: ft.Page):
    global pastas_historico
    if pastas_historico and pastas_historico[-1] == "./Libs/Scripts/Outros/":
        from Libs.Scripts.scripts import scripts_page
        page.clean()
        scripts_page(page)
...
def outros_page(page: ft.Page):
    ...
    path_to_list = "./Libs/Scripts/Outros/"
